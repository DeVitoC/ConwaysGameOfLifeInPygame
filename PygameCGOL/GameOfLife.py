...
class GameOfLife:
    ...
    def draw_board(self):
        ...
        self.setup_button(str(self.generation), 640, 625, 80, 25, inactive_color=self.alive_color,
                          active_color=self.alive_color)
        self.setup_button("Generations", 640, 650, 80, 25, inactive_color=self.alive_color,
                          active_color=self.alive_color)
        pygame.display.flip()

    def setup_button(self, msg, xcoord, ycoord, width=100, height=50, inactive_color='turquoise',
                     active_color="light green", action=None):
        ...
        small_text = pygame.font.SysFont("comicsansms", 12)
        text_surf, text_rect = self.text_objects(msg, small_text)
        text_rect.center = ((xcoord + (width / 2)), (ycoord + (height / 2)))
    ...
    def handle_events(self):
        ...
        # User can press "-" to slow the game
            ...
            self.slower()
        # user can press "+" to speed up the game
